...
func (b *SharedNetworkBackend) ProxyMapUsage() (MapUsage, error) {
	return MapUsage{}, unsupportedSharedNetworkError()
}

func (b *SharedNetworkBackend) SweepOrphanedFlows(time.Duration) (SharedNetworkFlowSweepResult, error) {
	return SharedNetworkFlowSweepResult{}, unsupportedSharedNetworkError()
}
...
func (b *SharedNetworkBackend) TokenReservationFailures() (uint64, error) {
	return 0, unsupportedSharedNetworkError()
}
