...
static int update_cgroup_control(
    ...
    bool enable_ipv4,
    bool hijack_dns,
    bool bypass_private_address,
    bool dns_respect_bypass,
    ...
    if (bypass_private_address) control.flags |= SB_EBPF_CGROUP_FLAG_BYPASS_PRIVATE_ADDRESS;
    if (dns_respect_bypass) control.flags |= SB_EBPF_CGROUP_FLAG_DNS_RESPECT_BYPASS;
...
int sb_ebpf_cgroup_load_programs(
    ...
    if (update_cgroup_control(
            ...
            bypass_private_address, dns_respect_bypass,
    ...
    if (update_cgroup_control(
            runtime, listen_port, 0U, enable_ipv4, hijack_dns, bypass_private_address,
            dns_respect_bypass,
            udp_timeout_seconds,
